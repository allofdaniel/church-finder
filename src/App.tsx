...
// PNG 아이콘 경로 (Android WebView 호환)
const ICON_PATHS = {
  church: '/icons/church.png',
  catholic: '/icons/cathedral.png',
  temple: '/icons/buddha.png',
  cult: '/icons/caution.png'
}
...
function App() {
  ...
  // 맵 로드 핸들러 - 커스텀 아이콘 로드 (MapLibre loadImage API 사용)
  const handleMapLoad = useCallback(() => {
    const map = mapRef.current?.getMap()
    if (!map) return

    // MapLibre loadImage API 사용 (Android WebView 호환)
    const icons = [
      { id: 'church-icon', url: ICON_PATHS.church },
      { id: 'catholic-icon', url: ICON_PATHS.catholic },
      { id: 'temple-icon', url: ICON_PATHS.temple },
      { id: 'cult-icon', url: ICON_PATHS.cult }
    ]
